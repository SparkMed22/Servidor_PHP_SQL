<footer class="bg-white dark:bg-slate-950 border-t border-slate-200 dark:border-slate-800 pt-16 pb-8">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
            <div class="col-span-1 lg:col-span-1">
                <div class="flex items-center gap-3 mb-6">
                    ...
                    <h2 class="text-lg font-black text-primary">CREE</h2>
                </div>
                <p class="text-slate-500 dark:text-slate-400 text-sm leading-relaxed">
                    El Centro Regional de Educación Gral. Patricio Escobar es una institución líder en la
                    formación integral de ciudadanos comprometidos con el desarrollo del país.
                </p>
            </div>
            <div>
                <h4 class="text-sm font-bold uppercase tracking-widest mb-6">Enlaces Rápidos</h4>
                <ul class="flex flex-col gap-3 text-sm text-slate-500 dark:text-slate-400">
                    <li><a class="hover:text-primary transition-colors" href="#">Admisiones 2024</a></li>
                    <li><a class="hover:text-primary transition-colors" href="#">Calendario Escolar</a></li>
                    <li><a class="hover:text-primary transition-colors" href="#">Portal del Estudiante</a></li>
                    <li><a class="hover:text-primary transition-colors" href="#">Recursos Digitales</a></li>
                </ul>
            </div>
            <div>
                <h4 class="text-sm font-bold uppercase tracking-widest mb-6">Contacto</h4>
                <ul class="flex flex-col gap-4 text-sm text-slate-500 dark:text-slate-400">
                    <li class="flex items-start gap-3">
                        <span class="material-symbols-outlined text-primary">location_on</span>
                        <span>Avda. Irrazábal y Honorio González,<br />Encarnación, Paraguay</span>
                    </li>
                    <li class="flex items-center gap-3">
                        <span class="material-symbols-outlined text-primary">phone</span>
                        <span>+595 71 202 345</span>
                    </li>
                    <li class="flex items-center gap-3">
                        <span class="material-symbols-outlined text-primary">mail</span>
                        <span>contacto@cree.edu.py</span>
                    </li>
                </ul>
            </div>
            <div>
                <h4 class="text-sm font-bold uppercase tracking-widest mb-6">Síguenos</h4>
        ...
        <div
            class="border-t border-slate-100 dark:border-slate-800 pt-8 flex flex-col md:flex-row items-center justify-between text-xs text-slate-400">
            <p>© 2024 CREE - Gral. Patricio Escobar. Todos los derechos reservados.</p>
